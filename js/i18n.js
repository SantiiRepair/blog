    ...
    resources: {
      en: {
        translation: {
          ...
          og_description:
            "Digital obsession, motorcycle road trips and alternative music",
      ...
      es: {
        translation: {
          ...
          og_description:
            "Obsesión digital, viajes en motocicleta y música alternativa",
          about_title: "Sobre mí",
          favorites: "Favoritos",
          trips: "Viajes",
          about_image_alt: "yo",
          about_text:
            "Soy ese tipo — el fantasma con motocicleta. No me encontrarás en casa. Cada día voy rodando a algún lugar nuevo, persiguiendo curvas o rincones tranquilos. Cuando el sol se esconde, me transformo en otra cosa: una criatura del brillo de la pantalla, programando en la oscuridad, perdiéndome en películas y series aleatorias que me encuentran más de lo que yo las encuentro. Así que si estás por ahí y el aburrimiento se está colando… envía una señal de humo. Ya estoy mirando al horizonte; lo veré. ¿Qué dices? ¿Te apetece una copa con un jinete fantasma? O simplemente acompáñame en la carretera un rato, sin destino fijo. Quizá solo hablemos tomando café mientras el mundo duerme. Estoy aquí. Estoy aquí afuera. Así que dime… ¿qué quieres?",
          ps_note: "pd. hablame si te gusta hablar de rutas y tragos ;p",
          chat_title:
            "Cbox es una aplicación web de chat en tiempo real integrada",
        },
      },
      de: {
        translation: {
          ...
          og_description:
            "Digitale Obsession, Motorradreisen und alternative Musik",
          ...
          ps_note:
            "ps. melde dich, wenn du über Roadtrips und Drinks reden magst ;p",
      ...
      ru: {
        translation: {
          ...
          og_description:
            "Цифровая одержимость, мотоциклетные путешествия и альтернативная музыка",
          about_title: "Обо мне",
          favorites: "Избранное",
          trips: "Поездки",
          about_image_alt: "я",
          ...
          ps_note:
            "п.с. напиши, если любишь говорить о поездках на мотоцикле и выпивке ;p",
          chat_title:
            "Cbox — это встроенное веб-приложение для чата в реальном времени",
        },
      },
    },
  },
