  ...
  en: {
    translation: {
      ...
      kuromi_surprise_text_1: "Is it today, April 28th? Was it today????? 😵‍💫",
        kuromi_surprise_text_1_age: "And hey, happy {{age}}{{kuromi_surprise_age_suffix}}, have a great one 🫶🏻",
      kuromi_surprise_text_2: "Did you know... for your brain, a 'what if' weighs the same as a fact?",
        kuromi_surprise_text_2_age: "And hey, happy {{age}}{{kuromi_surprise_age_suffix}}, have a great one 🫶🏻",
      kuromi_surprise_text_3: "In those {{months}} months and {{days}} days, did you ever go to Sushi Tei?",
        kuromi_surprise_text_3_age: "And hey, happy {{age}}{{kuromi_surprise_age_suffix}}, have a great one 🫶🏻",
      kuromi_surprise_text_4: "NAHERLYS VALENTINA!!! {{bestTime}}s? Really? I beat you 😝. Come on, you can do it faster",
  ...
  es: {
    translation: {
      ...
      kuromi_surprise_text_1: "Es hoy 28 de Abril, ¿no? Era hoy verdad????? 😵‍💫",
        kuromi_surprise_text_1_age: "Y hey, felices {{age}}{{kuromi_surprise_age_suffix}}, pásala genial 🫶🏻",
      kuromi_surprise_text_2: "¿Sabías que... para tu cerebro un \"ojalá\" pesa lo mismo que un hecho?",
        kuromi_surprise_text_2_age: "Y hey, felices {{age}}{{kuromi_surprise_age_suffix}}, pásala genial 🫶🏻",
      kuromi_surprise_text_3: "En estos {{months}} meses y {{days}} días fuiste a Sushi Tei?",
        kuromi_surprise_text_3_age: "Y hey, felices {{age}}{{kuromi_surprise_age_suffix}}, pásala genial 🫶🏻",
      kuromi_surprise_text_4: "NAHERLYS VALENTINA!!! {{bestTime}}s? ¿En serio? Te gané 😝. Vamos, puedes hacerlo más rápido",
  ...
  de: {
    translation: {
      ...
      kuromi_surprise_text_1: "Ist heute der 28. April? War es heute????? 😵‍💫",
        kuromi_surprise_text_1_age: "Und hey, schöne {{age}}{{kuromi_surprise_age_suffix}}, feier schön 🫶🏻",
      kuromi_surprise_text_2: "Wusstest du, dass... für dein Gehirn ein 'Was wäre wenn' genauso viel wiegt wie eine Tatsache?",
        kuromi_surprise_text_2_age: "Und hey, schöne {{age}}{{kuromi_surprise_age_suffix}}, feier schön 🫶🏻",
      kuromi_surprise_text_3: "In diesen {{months}} Monaten und {{days}} Tagen, warst du irgendwann bei Sushi Tei?",
        kuromi_surprise_text_3_age: "Und hey, schöne {{age}}{{kuromi_surprise_age_suffix}}, feier schön 🫶🏻",
      kuromi_surprise_text_4: "NAHERLYS VALENTINA!!! {{bestTime}}s? Echt jetzt? Ich war schneller 😝. Du schaffst das noch schneller!",
  ...
  ru: {
    translation: {
      ...
      kuromi_surprise_text_1: "Сегодня 28 апреля, да? Сегодня был этот день????? 😵‍💫",
        kuromi_surprise_text_1_age: "И эй, с {{age}}{{kuromi_surprise_age_suffix}}, отлично отпразднуй 🫶🏻",
      kuromi_surprise_text_2: "Знаешь ли ты... для твоего мозга 'а если бы' весит столько же, сколько и факт?",
        kuromi_surprise_text_2_age: "И эй, с {{age}}{{kuromi_surprise_age_suffix}}, отлично отпразднуй 🫶🏻",
      kuromi_surprise_text_3: "За эти {{months}} месяцев и {{days}} дней ты хоть раз был в Sushi Tei?",
        kuromi_surprise_text_3_age: "И эй, с {{age}}{{kuromi_surprise_age_suffix}}, отлично отпразднуй 🫶🏻",
      kuromi_surprise_text_4: "NAHERLYS VALENTINA!!! {{bestTime}}с? Серьёзно? Я тебя обогнал 😝. Давай, ты можешь быстрее!",
